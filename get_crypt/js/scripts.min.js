...
(function ($) {
  ...
  $.fn.jselector = $.fn.jSelector = function (arg) {
    ...
    function make() {
      ...
      var $items, $selected_item, $selected_option, $options, $optgroups;
      var shown = false;

      var new_items = function new_items($parent) {
...
$(document).ready(function () {
  //----------Jselector-----//
  $('select').jselector(); // setInterval(getRate, 5000);
...
function getRateEth() {
  var hour, day, week, month, symbol, changeNotation, currency, symbolCur; // Currency selector //
  ...
  $.get('https://apiv2.bitcoinaverage.com/indices/global/ticker/ETH' + currency, function (data) {
    ...
    if (hour === "") {
      $("#hour").html("unknown").css('color', 'white');
    } // Hour change
    else if (hour >= 0) {
        $("#hour").html("+" + hour + symbol).css('color', '#11c536');
      } else {
        $("#hour").html(hour + symbol).css('color', '#ea061f');
      }

    ;

    if (day === "") {
      $("#day").html("unknown").css('color', 'white');
    } //Day change
    else if (day >= 0) {
        $("#day").html("+" + day + symbol).css('color', '#11c536');
      } else {
        $("#day").html(day + symbol).css('color', '#ea061f');
      }

    ;

    if (week === "") {
      $("#week").html("unknown").css('color', 'white');
    } //Week change
    else if (week >= 0) {
        $("#week").html("+" + week + symbol).css('color', '#11c536');
      } else {
        $("#week").html(week + symbol).css('color', '#ea061f');
      }

    ;

    if (month === "") {
      $("#month").html("unknown").css('color', 'white');
    } //Month change
    else if (month >= 0) {
        $("#month").html("+" + month + symbol).css('color', '#11c536');
      } else {
        $("#month").html(month + symbol).css('color', '#ea061f');
      }
...
function getRateLtc() {
  ...
  $.get('https://apiv2.bitcoinaverage.com/indices/global/ticker/LTC' + currency, function (data) {
    ...
    if (hour === "") {
      $("#hour1").html("unknown").css('color', 'white');
    } // Hour change
    else if (hour >= 0) {
        $("#hour1").html("+" + hour + symbol).css('color', '#11c536');
      } else {
        $("#hour1").html(hour + symbol).css('color', '#ea061f');
      }

    ;

    if (day === "") {
      $("#day1").html("unknown").css('color', 'white');
    } //Day change
    else if (day >= 0) {
        $("#day1").html("+" + day + symbol).css('color', '#11c536');
      } else {
        $("#day1").html(day + symbol).css('color', '#ea061f');
      }

    ;

    if (week === "") {
      $("#week1").html("unknown").css('color', 'white');
    } //Week change
    else if (week >= 0) {
        $("#week1").html("+" + week + symbol).css('color', '#11c536');
      } else {
        $("#week1").html(week + symbol).css('color', '#ea061f');
      }

    ;

    if (month === "") {
      $("#month1").html("unknown").css('color', 'white');
    } //Month change
    else if (month >= 0) {
        $("#month1").html("+" + month + symbol).css('color', '#11c536');
      } else {
        $("#month1").html(month + symbol).css('color', '#ea061f');
      }
...
function getRateBtc() {
  ...
  $.get('https://apiv2.bitcoinaverage.com/indices/global/ticker/BTC' + currency, function (data) {
    ...
    if (hour === "") {
      $("#hour2").html("unknown").css('color', 'white');
    } // Hour change
    else if (hour >= 0) {
        $("#hour2").html("+" + hour + symbol).css('color', '#11c536');
      } else {
        $("#hour2").html(hour + symbol).css('color', '#ea061f');
      }

    ;

    if (day === "") {
      $("#day2").html("unknown").css('color', 'white');
    } //Day change
    else if (day >= 0) {
        $("#day2").html("+" + day + symbol).css('color', '#11c536');
      } else {
        $("#day2").html(day + symbol).css('color', '#ea061f');
      }

    ;

    if (week === "") {
      $("#week2").html("unknown").css('color', 'white');
    } //Week change
    else if (week >= 0) {
        $("#week2").html("+" + week + symbol).css('color', '#11c536');
      } else {
        $("#week2").html(week + symbol).css('color', '#ea061f');
      }

    ;

    if (month === "") {
      $("#month2").html("unknown").css('color', 'white');
    } //Month change
    else if (month >= 0) {
        $("#month2").html("+" + month + symbol).css('color', '#11c536');
      } else {
        $("#month2").html(month + symbol).css('color', '#ea061f');
      }
