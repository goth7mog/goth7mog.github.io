 ...
 * В© Anatoly Lunev | toliklunev.ru | toliklunev@gmail.com
...
;(function($){
	...
	$.fn.jselector = $.fn.jSelector = function(arg){
		...
		function make(){
			...
			// СѓСЃС‚Р°РЅР°РІР»РёРІР°РµС‚ РјРёРЅРёРјР°Р»СЊРЅСѓСЋ С€РёСЂРёРЅСѓ
			...
			$select.bind('jselector:update', function(){
				...
				/* Р’СЃС‚Р°РІР»СЏРµРј С‚РµРєСЃС‚ РїР»РµР№СЃС…РѕР»РґРµСЂР°, РµСЃР»Рё РѕРЅ Р·Р°РґР°РЅ, Рё Сѓ option РЅРµС‚ Р°С‚СЂРёР±СѓС‚Р° selected */
